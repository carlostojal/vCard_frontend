    ...
    if(phone_number.value != '' || password.value != ''){
        ...
        try {
            ...
            if(response.data.status == "success"){ // login valido
              ...
              // router.go(url_home);
              window.location.href = url_home.value
            }else{ // login invalido
    ...
    <form>
      <div class="form-wrapper">
        ...
        <div class="form-outline mb-4">
          ...
          <input v-model="phone_number" style="border-width: 2px; border-color: black;"  maxlength="9" id="form2Example1" class="form-control" />
        </div>
